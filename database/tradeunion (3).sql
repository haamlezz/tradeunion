...
--
-- Host: localhost
-- Generation Time: May 17, 2022 at 02:06 PM
...
CREATE TABLE `college` (
  ...
  `local_president` int(11) DEFAULT NULL COMMENT 'ປະທານກຳມະບານຮາກຖານ'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `college` (`col_id`, `col_name`, `col_village`, `col_district`, `col_province`, `tel`, `email`, `local_president`) VALUES
(1, 'ວິທະຍາໄລ ລາວ-ທ໊ອບ', 'ບ້ານ ໂພນປ່າເປົ້າ', 'ເມືອງ ສີສັດຕະນາກ', 'ນະຄອນຫຼວງວຽງຈັນ', '021353800', 'info@laotop.net', 1),
(2, 'ວິທະຍາໄລ ລາວນາໆຊາດ', 'ບ້ານ ສະພານທອງ', 'ສີສັດຕະນາກ', 'ນະຄອນຫຼວງວຽງຈັນ', '021412558', 'lic.college@hotmail.com', 2),
(6, 'ວິທະຍາໄລ ສອນພິທັກ', 'ບ້ານ ໂສກປ່າຫຼວງ', 'ເມືອງ ສີສັດຕະນາກ', 'ນະຄອນຫຼວງວຽງຈັນ', '021 123456', 'sonephithak@gmail.com', NULL),
(7, 'ສະຖານບັນຣັດຕະນະບໍລິຫານທຸລະກິດ', 'ບ້ານ ໂພນທັນ', 'ເມືອງ ສີສັດຕະນາກ', 'ນະຄອນຫຼວງວຽງຈັນ', '021555555', 'rbac@gmail.com', NULL),
(8, 'ວິທະຍາໄລ ....', 'DDD', 'SSS', 'AAAA', '33333', 'eeee@gmail.com', NULL);
...
CREATE TABLE `member` (
  ...
  `join_local` date NOT NULL COMMENT 'ວັນທີຮັບເຂົ້າຮາກຖານ'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `member` (`mem_id`, `username`, `password`, `role`, `book_no`, `firstname`, `lastname`, `gender`, `ethnic`, `dob`, `h_village`, `h_district`, `h_province`, `addr_village`, `addr_district`, `addr_province`, `join_trade_union_date`, `join_party_date`, `join_women_union_date`, `status`, `group_id`, `join_local`) VALUES
(1, 'sompasong', '$2y$10$8yoLkykBvFdsPjeor.M5C.XUi8qrPMR33uScJD.VXVA88b5zb9ola', 2, 101, 'admin', 'admin', 'ຊາຍ', 'ພຸດ', '1987-09-19', 'ໜອງບົວທອງ', 'ສີໂຄດຕະບອງ', 'ນະຄອນຫຼວງວຽງຈັນ', 'ສົມໂຮງ', 'ຫາດຊາຍຟອງ', 'ນະຄອນຫຼວງວຽງຈັນ', '2019-02-14', '2022-04-21', '2022-05-07', 1, 1, '2017-02-06'),
(2, 'haamlezz', '$2y$10$OumdooZsG8JS9B9mp37pPeBBSPtVQHhlKOPp/PLVJPyufmBgYOiMm', 2, 333, 'll', 'll', 'ຍິງ', 'lll', '1974-05-03', 'll', 'l', 'll', 'll', 'l', 'l', '2022-01-01', '2022-01-01', '2022-01-01', 1, 5, '2022-05-01'),
(3, 'vilaisak', '$2y$10$aBcYonRlxPnfeNc9X336ruXemc2F8ZW8D2O5hNfQId0lPK4pJ49wO', 3, 333, 'ວິໄລສັກ', 'ຂັນຕິວົງ', 'ຊາຍ', 'ລາວລຸ່ມ', '1974-06-04', 'ກກກ', 'ຂຂຂ', 'ມມມ', 'ຊຊຊ', 'ບບບ', 'ລລລ', '2022-05-08', NULL, NULL, 0, 3, '2020-06-16'),
(4, 'sam', '$2y$10$aSt6oF5jo7xfolImJufzwO5W3zmoMY/sRzYfrlcnXOYwSzC5k1sLO', 1, 111, 'ພັນທະວິໄລ', 'ນວນຮຸ່ນ', 'ຊາຍ', 'ລາວລຸ່ມ', '1984-04-09', 'ດົງປາແຫຼບ', 'ສີໂຄດຕະບອງ', 'ນະຄອນຫຼວງ', 'ໜອງດ້ວງ', 'ສີໂຄດຕະບອງ', 'ນະຄອນຫຼວງວຽງຈັນ', '2022-05-08', '2022-05-07', '2022-05-06', 1, 1, '2022-05-08'),
(5, 'soumek', '$2y$10$VKbjUz.H17WkAkL4UQlvVO3Cu.agwZwQzPhASFa96DjXzGz.7atEq', 3, 11, 'ສຸເມກ', 'ສຸວັນນະໄລ', 'ຊາຍ', 'ລາວລຸ່ມ', '2001-10-07', 'ວຽງແກ້ວ', 'ທຸລະຄົມ', 'ວຽງຈັນ', 'ນາແຄ', 'ໄຊທານີ', 'ນະຄອນຫຼວງວຽງຈັນ', '2020-01-03', NULL, NULL, 2, 4, '2022-05-01'),
(6, 'ddd', '$2y$10$I.XX14SO3AlPyqmDM8366u9ILn6dC4CTj1bKY86T3lKhFINGZk4zy', 3, 333, 'ddd', 'ddd', 'ຍິງ', 'ລາວລຸ່ມ', '2000-01-01', 'ກກກ', 'ກກກ', 'ຄຳມ່ວນ', 'ກກກ', 'ກກກ', 'ນະຄອນຫຼວງວຽງຈັນ', '2022-05-17', NULL, NULL, 1, 4, '2022-05-17');
...
--
ALTER TABLE `college`
  MODIFY `col_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ລະຫັດຮາກຖານ', AUTO_INCREMENT=10;
...
--
ALTER TABLE `member`
  MODIFY `mem_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ລະຫັດສະມາຊິກ', AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `membership_fee`
--
ALTER TABLE `membership_fee`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ລະຫັດເສຍຄ່າສະຕິ', AUTO_INCREMENT=29;
